    ...
    <div className="rounded-2xl bg-surface p-5 shadow-sm">
      ...
      <div className="flex items-center gap-3 mb-4">
        {representativeImage && (
          <img
            ...
            className="h-14 w-14 rounded-xl object-cover bg-accent/10 shrink-0"
          />
        )}
        <div>
      ...
      <div className="mb-4 grid grid-cols-2 gap-3 sm:grid-cols-4">
        <div className="rounded-lg bg-bg p-3 text-center">
          <p className="text-xs text-text-muted">{t('common:session.sets')}</p>
          <p className="text-lg font-bold text-text-primary">{sets}</p>
        </div>
        <div className="rounded-lg bg-bg p-3 text-center">
          <p className="text-xs text-text-muted">{t('common:session.reps')}</p>
          <p className="text-lg font-bold text-text-primary">{repsDisplay}</p>
        </div>
        {weightKg !== undefined && (
          <div className="rounded-lg bg-bg p-3 text-center">
        ...
        {rpe !== undefined && (
          <div className="rounded-lg bg-bg p-3 text-center">
            <p className="text-xs text-text-muted">{t('common:session.rpe')}</p>
            <p className="text-lg font-bold text-text-primary">{rpe}</p>
          </div>
        )}
        <div className="rounded-lg bg-bg p-3 text-center">
          <p className="text-xs text-text-muted">{t('common:session.rest_seconds')}</p>
          <p className="text-lg font-bold text-text-primary">{restSeconds}</p>
        </div>
      </div>
      ...
      {(() => {
        ...
        return (
          <details className="group">
            <summary className="cursor-pointer text-sm font-medium text-text-muted group-open:mb-2">
